...
$search_bugs = "SELECT * from bugs WHERE bug_title LIKE '%$search%' OR bug_text LIKE '%$search%' OR bug_priority LIKE '%$search%' OR bug_status LIKE '%$search%' OR bug_application LIKE '%$search%' ORDER BY bug_id DESC";

$result = mysqli_query($link, $search_bugs) or die(mysqli_error($link));
