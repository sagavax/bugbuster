<?php include "../includes/dbconnect.php";
      ...
      session_start();
        ...
        $create_record="INSERT INTO ideas_timeline (object_id, object_type,parent_object_id ,timeline_text, created_date) VALUES ($last_idea_id, 'idea', $last_idea_id,'$diary_text', now())";
