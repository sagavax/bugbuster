<?php
    ...
    $idea_title = mysqli_real_escape_string($link,$data['idea_title']) ?? '';
    $idea_description = mysqli_real_escape_string($link,$data['idea_text']) ?? '';
    $idea_application = mysqli_real_escape_string($link,$data['idea_application']) ?? '';
